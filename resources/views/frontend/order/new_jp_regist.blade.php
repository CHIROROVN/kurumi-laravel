...
<section class="order-child clear" id="contact">
  <div class="container">
  	<h1 class="title-content">くるみサーバーお申込フォーム(汎用jpドメイン新規)</h1>
    <div class="content">
      ...
      <h3>ご担当者について</h3>
       <table class="form-input">
        ...
        <tr>
          ...
          <td>
             〒 <input type="text" name="person_charge_zipcode" value="{{old('person_charge_zipcode')}}" class="mr-bottom10 input-xs person-status"/>
