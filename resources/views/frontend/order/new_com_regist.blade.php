...
<section class="order-child clear" id="contact">
  <div class="container">
    ...
    <div class="content">
    {!! Form::open(array('route' => ['frontend.order.new-com_regist', 'method' => 'post', 'enctype'=>'multipart/form-data', 'accept-charset'=>'utf-8'])) !!}
      ...
      <h3>ドメイン登録情報</h3>
       <table class="form-input">
        ...
        <tr>
          ...
          <div class="text-message">@if ($errors->first('dns_phone')) ※{!! $errors->first('dns_phone') !!} @endif</div></td>
        </tr>
        <tr>
