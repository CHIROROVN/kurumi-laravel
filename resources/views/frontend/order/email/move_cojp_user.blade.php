...
サービス開始希望日　　　　　　：@if( $data['app_service_start_date'] == 1 )希望なし（お申込みの翌営業日より2～3営業日目にサービス開始）
@else
希望あり
@endif
...
外部バックアップ世代数追加　　：{{$data['app_generation']}}世代
IPアドレス追加　　　　　　　　：{{$data['app_individual']}}個
...
@elseif( $data['ssl_email_address'] == 4 )webmaster@ドメイン名　→　SSL申請後に確認メールが届くので、info@kurumiserver.jp へ、そのまま転送してください
@elseif( $data['ssl_email_address'] == 5)postmaster@ドメイン名　→　SSL申請後に確認メールが届くので、info@kurumiserver.jp へ、そのまま転送してください
...
上記に内容で開通を進めさせていただきますので、設定が完了次第、
サーバー開通のご案内メールをお送りさせていただきます。

今後とも、チロロネットをご愛顧の程、よろしくお願い申し上げます。
