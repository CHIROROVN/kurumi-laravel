...
<table border="0">
	...
	<tr>
		<td>AuthCode</td>
		<td>:{{ $data['domain_authcode'] }}</td>
	</tr>
	<tr>
		<td>組織名（英語）</td>
		<td>:{{ $data['domain_organization_name'] }}</td>
	</tr>
	<tr>
		<td>所有者名</td>
		<td>:{{ $data['domain_owner_name'] }}</td>
	</tr>
	<tr>
		<td>部署名</td>
		<td>:{{ $data['domain_department_name'] }}</td>
	</tr>
	<tr>
		<td>役職名</td>
		<td>:{{ $data['domain_title'] }}</td>
	</tr>
	<tr>
		<td>ご住所（英語）</td>
