...
AuthCode　　　　　　　　　　：{{$data['domain_authcode']}}
組織名（英語）　　　　　　　　：{{$data['domain_organization_name']}}
所有者名　　　　　　　　　　：{{$data['domain_owner_name']}}
部署名　　　　　　　　　　　：{{$data['domain_department_name']}}
役職名　　　　　　　　　　　：{{$data['domain_title']}}
ご住所（英語）　　　　　　　　：{{$data['domain_youraddress_english']}}
