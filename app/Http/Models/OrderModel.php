...
//            'individual'                              => 'required',
            ...
            'organization_en'                         => 'required|regex:/^[A-Za-z0-9\-! ,\'\"\/@\.:\(\)]+$/',
            'postal_code'                             => 'required',
            'address_jp'                              => 'required',
            'address_en'                              => 'required|regex:/^[A-Za-z0-9\-! ,\'\"\/@\.:\(\)]+$/',
            'regist_date'                             => 'required',
            'regist_land_address'                     => 'required',
            'representative_jp'                       => 'required',
            'representative_en'                       => 'required|regex:/^[A-Za-z0-9\-! ,\'\"\/@\.:\(\)]+$/',
            'representative_title'                    => 'required',

            'domain_person_jp'                        => 'required',
            'domain_person_en'                        => 'required|regex:/^[A-Za-z0-9\-! ,\'\"\/@\.:\(\)]+$/',
            ...
            'organization_name_en'                    => 'required|regex:/^[A-Za-z0-9\-! ,\'\"\/@\.:\(\)]+$/',
            'prefectures_jp'                          => 'required',
            'prefectures_en'                          => 'required|regex:/^[A-Za-z0-9\-! ,\'\"\/@\.:\(\)]+$/',
    ...
    public function MsgNewCoJp()
    {
        return array(
            ...
            'organization_en.regex'                         => trans('validation.error_organization_en_alpha_num'),
            ...
            'address_en.regex'                              => trans('validation.error_address_en_alpha_num'),
            ...
            'representative_en.regex'                       => trans('validation.error_representative_enpostal_code_alpha_num'),
            ...
            'domain_person_en.regex'                        => trans('validation.error_domain_person_en_alpha_num'),
            ...
            'phone_number.numeric'                          => trans('validation.error_phone_number_numeric'),
            'ssl_fax.numeric'                               => trans('validation.error_ssl_fax_numeric'),
            ...
            'domain_phone.numeric'                          => trans('validation.error_domain_phone_numeric'),
            ...
            'domain_email.email'                            => trans('validation.error_domain_email_email'),
            ...
            'organization_name_en.regex'                    => trans('validation.error_organization_name_en_alpha_num'),
            ...
            'prefectures_en.regex'                          => trans('validation.error_prefectures_en_alpha_num'),
            ...
            'person_charge_fax.numeric'                     => trans('validation.error_person_charge_fax_numeric'),
    ...
    public function RuleNewJp()
    {
        return array(
            ...
            'dns_organization_en'                     => 'required|regex:/^[A-Za-z0-9\-! ,\'\"\/@\.:\(\)]+$/',

            'dns_owner_name'                          => 'required',
            'dns_dept_name'                           => 'required',
            'dns_addrs_jp'                            => 'required',
            'dns_addrs_en'                            => 'required|regex:/^[A-Za-z0-9\-! ,\'\"\/@\.:\(\)]+$/',
    ...
    public function MsgNewJp()
    {
        return array(
            ...
            'dns_organization_en.regex'                     => trans('validation.error_dns_organization_en_alpha_num'),
            ...
            'dns_addrs_en.regex'                            => trans('validation.error_dns_addrs_en_alpha_num'),
